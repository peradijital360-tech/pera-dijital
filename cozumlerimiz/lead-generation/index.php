    ...
    <div class="band__inner">
      ...
      <div class="faq-grid">
        <details class="card faq">
          ...
          <p class="faq__answer">Kampanya yayına girip platform onayını aldıktan sonra kayıt gelmeye başlayabilir; asıl süre ondan önceki hazırlıkta. Nitelik tanımı, landing page ve takip kurulumu tamamlanmadan kampanya açmıyoruz. Hazırlığın süresi sayfanın kapsamına ve içerik onayının hızına bağlı. İlk günlerin kayıt sayısı sonraki dönemin göstergesi değil; kaliteyi okuyabilmek için satış ekibinin yeterli sayıda kaydı işaretlemiş olması gerekiyor.</p>
        </details>
        <details class="card faq">
      ...
      <script type="application/ld+json">
      {
        ...
        "inLanguage": "tr-TR",
        "mainEntity": [
          { "@type": "Question", "name": "Ne kadar sürede kayıt gelmeye başlar?", "acceptedAnswer": { "@type": "Answer", "text": "Kampanya yayına girip platform onayını aldıktan sonra kayıt gelmeye başlayabilir; asıl süre ondan önceki hazırlıkta. Nitelik tanımı, landing page ve takip kurulumu tamamlanmadan kampanya açmıyoruz. Hazırlığın süresi sayfanın kapsamına ve içerik onayının hızına bağlı. İlk günlerin kayıt sayısı sonraki dönemin göstergesi değil; kaliteyi okuyabilmek için satış ekibinin yeterli sayıda kaydı işaretlemiş olması gerekiyor." } },
