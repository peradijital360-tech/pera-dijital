    ...
    <div class="band__inner">
      ...
      <div class="faq-grid">
        <details class="card faq">
          ...
          <p class="faq__answer">Fiyat sayfa sayısıyla değil, özel tasarlanan şablon sayısıyla belirleniyor. On sayfalık bir sitede çoğu zaman dört veya beş farklı şablon vardır; geri kalan sayfalar aynı şablonun içeriği değişmiş hâlidir. Fiyatı belirleyen diğer üç şey: çok dilli olup olmadığı, form ve CRM gibi entegrasyonlar ve metin ile görsellerin hazır olup olmadığı. Teklif, kapsam yazıya döküldükten sonra tek kalem veriliyor; saatlik çalışmıyoruz. Güncel aralık: <strong>[REPLACE &mdash; fiyat aralığı]</strong>.</p>
        </details>
        <details class="card faq">
      ...
      <script type="application/ld+json">
      {
        ...
        "inLanguage": "tr-TR",
        "mainEntity": [
          { "@type": "Question", "name": "Kurumsal bir web sitesi ne kadara mal olur, fiyatı ne belirler?", "acceptedAnswer": { "@type": "Answer", "text": "Fiyat sayfa sayısıyla değil, özel tasarlanan şablon sayısıyla belirleniyor. On sayfalık bir sitede çoğu zaman dört veya beş farklı şablon vardır; geri kalan sayfalar aynı şablonun içeriği değişmiş hâlidir. Fiyatı belirleyen diğer üç şey: çok dilli olup olmadığı, form ve CRM gibi entegrasyonlar ve metin ile görsellerin hazır olup olmadığı. Teklif, kapsam yazıya döküldükten sonra tek kalem veriliyor; saatlik çalışmıyoruz. Güncel aralık: [REPLACE — fiyat aralığı]." } },
          { "@type": "Question", "name": "Kurumsal site projesi ne kadar sürede yayına girer?", "acceptedAnswer": { "@type": "Answer", "text": "Süreyi en çok iki şey uzatıyor: metinlerin geç gelmesi ve tasarım onaylarının beklemede kalması. Kodlama tarafı tahmin edilebilir; belirsizlik içerikte. İçerik hazırsa süreç bilgi mimarisi onayından sonra kesintisiz ilerliyor. Kapsam netleştiğinde takvimi tarih vererek yazıyor ve onayınıza sunuyoruz. Tipik süre: [REPLACE — proje türüne göre süre aralığı]." } },
